...
public final class Data extends Message<Data, Data.Builder> {
    ...
    @WireField(
            tag = 2,
            adapter = "com.howard.designcontact.Person#ADAPTER",
    ...
    @WireField(
            tag = 3,
            adapter = "com.howard.designcontact.Phone#ADAPTER",
            label = WireField.Label.REPEATED
    )
    ...
    private static final class ProtoAdapter_Data extends ProtoAdapter<Data> {
        ...
        public Data decode(ProtoReader reader) throws IOException {
            ...
            for (int tag; (tag = reader.nextTag()) != -1; ) {
                switch (tag) {
                    case 1:
                        builder.user(ProtoAdapter.STRING.decode(reader));
                        break;
                    case 2:
                        builder.persons.add(Person.ADAPTER.decode(reader));
                        break;
                    case 3:
                        builder.phoned.add(Phone.ADAPTER.decode(reader));
                        break;
                    default: {
